 ...
 //     assert(min < max);
	...
	//
	 bool overlap(const Box &box) {
		 ...
		 return (parameters[1].x() > box.parameters[0].x() && parameters[0].x() < box.parameters[1].x() &&
			 parameters[1].y() > box.parameters[0].y() && parameters[0].y() < box.parameters[1].y() &&
			 parameters[1].z() > box.parameters[0].z() && parameters[0].z() < box.parameters[1].z());
	}
